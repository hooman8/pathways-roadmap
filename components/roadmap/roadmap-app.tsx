...
export default function RoadmapApp() {
  ...
  const blockers = prerequisiteTasks.filter(t => !isResolved(t));
  const impediments = task ? leafTasks(task.id, tasks).filter(t => t.status === "blocked") : [];
