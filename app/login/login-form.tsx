...
export default function LoginForm({ config }: { config: { apiKey: string; authDomain: string; projectId: string } | null }) {
  ...
  async function signIn() {
    ...
    try {
      const [{ initializeApp, getApps }, { getAuth, GoogleAuthProvider, signInWithPopup, setPersistence, inMemoryPersistence, signOut }] = await Promise.all([import("firebase/app"), import("firebase/auth")]);
